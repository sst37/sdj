      ...
      while (choice != 6)
      {
         ...
         {// calculate the area of circle
            ...
            JOptionPane.showMessageDialog(null,
                  "The area of the Circle:    " + area, "result",
         ...
         { // calculate the area of triangle
            ...
            area = (width * length) / 2;
            JOptionPane.showMessageDialog(null,
                  "The area of triangle:     " + area, "result",
                  JOptionPane.INFORMATION_MESSAGE);
         }
         ...
         {// calculate the area of square
            ...
            area = length * length;
            JOptionPane.showMessageDialog(null,
                  "The area of the square:    " + area, " result",
                  JOptionPane.INFORMATION_MESSAGE);
         }
         ...
         {// calculate the area of rectangle
            ...
            area = width * length;
            JOptionPane.showMessageDialog(null,
                  "The area of the rectangle:     " + area, "result",
                  JOptionPane.INFORMATION_MESSAGE);
         }
         ...
         {// calculat the area of cube
            ...
            area = 6 * length;
            JOptionPane.showMessageDialog(null,
                  "The area of the cube:  " + area, "result",
                  JOptionPane.INFORMATION_MESSAGE);
         }
         value = JOptionPane.showInputDialog("Please chose one of the options:"
               + "\n" + "a)Enter 1 to calculate the area of the Circle" + "\n"
